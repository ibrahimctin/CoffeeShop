...
namespace CoffeeShop.Domain.Application.DTOs.CoffeeProduct.ResponseDtos
{
    public class CoffeeProductDetail:BaseDto
    {
        ...
        public ICollection<CoffeeCategoryDetail> CoffeeCategories { get; set; }
    }
}
